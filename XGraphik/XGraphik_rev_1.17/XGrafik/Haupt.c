...
char            *leftDefault = 
                        "XGraphic Library copyright (c) 1994, FernUni Hagen",
                *rightDefault = "RCS Rev. 1.17";
...
XGF_SetDefault (void)
{
        XGF_SetLeft (leftDefault);
        XGF_SetRight (rightDefault);
}
